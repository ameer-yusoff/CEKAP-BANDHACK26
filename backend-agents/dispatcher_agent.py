...
def send_telegram_dispatch(record_id: str, emergency_details: str, latitude: str, longitude: str) -> str:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            logger.info("\n========================================================\n🚨 EMERGENCY MISSION SUCCESSFULLY COMPLETED 🚨\nDispatch network closed.\n========================================================")
            return f"SUCCESS: Message dispatched to Telegram for Record ID {record_id}."
        else:
...
def terminate_emergency_session() -> str:
    ...
    This securely retires the room in the database so a new session can start.
    """
...
async def main():
    ...
    # Notice the termination tool is added here
